  ...
  return (
    <div className="flex-row-container ebook">
      <div className="width-30 container">
        <div
          className="flex-row-container justify-items-center cover-container"
        >
          <img
      ...
      <div
        className="info-container width-70 flex-column-container
        justify-items-start align-items-stretch"
      >
        <div
          className="title-container margin-left-05 margin-right-05
          flex-row-container align-items-center"
        >
        ...
        <div
          className="authors-container flex-row-container align-items-start
          margin-left-05 margin-right-05"
        >
        ...
        <div
          className="narrators-container flex-row-container align-items-start
          margin-left-05 margin-right-05 margin-top-025"
        >
        ...
        <div
          className="progress-container margin-left-05 margin-right-05
          margin-top-025 flex-row-container align-items-center"
        >
        ...
        <div
          className="additional-info-container margin-left-05 margin-right-05
          margin-top-025 flex-row-container"
        >
          <div
            className="downloaded-container width-30 flex-row-container
            justify-items-start"
          >
            {ebook.isDownloaded && (
          ...
          <div
            className="runtime-container width-70 flex-row-container
